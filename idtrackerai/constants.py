...
NUMBER_OF_JOBS_FOR_BACKGROUND_SUBTRACTION = (
    -2
)  # Set None to use the default mode of the system. (see segmentation_utils.py module for details)
"""***NUMBER_OF_JOBS_FOR_SEGMENTATION***
Number of jobs used to perform the segmentation
"""
NUMBER_OF_JOBS_FOR_SEGMENTATION = (
    -2
)  # Set None to use the default mode of the system. (see segmentation.py module for details)
...
"""
LEARNING_RATE_IDCNN_PRETRAINING = float(
    os.environ.get("LEARNING_RATE_IDCNN_PRETRAINING", 0.01)
)
"""***LEARNING_RATE_DCD***
"""
...
"""
KEEP_PROB_IDCNN_ACCUMULATION = float(
    os.environ.get("KEEP_PROB_IDCNN_ACCUMULATION", 1.0)
)
"""***KEEP_PROB_IDCNN_PRETRAINING***
"""
KEEP_PROB_IDCNN_PRETRAINING = float(
    os.environ.get("KEEP_PROB_IDCNN_PRETRAINING", 1.0)
)
"""***KEEP_PROB_DCD***
"""
...
MAXIMUM_NUMBER_OF_EPOCHS_DCD = int(
    os.environ.get("MAXIMUM_NUMBER_OF_EPOCHS_DCD", 100)
)
...
CONVERT_TRAJECTORIES_DICT_TO_CSV_AND_JSON = bool(
    distutils.util.strtobool(
        os.environ.get("CONVERT_TRAJECTORIES_DICT_TO_CSV_AND_JSON", "False")
    )
)
