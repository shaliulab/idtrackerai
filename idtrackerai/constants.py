...
FRAMES_PER_EPISODE = int(os.environ.get("FRAMES_PER_EPISODE", 700))
...
BLOB_CONNECTION_PROCESS_SIZE=1500
NUMBER_OF_JOBS_TO_GENERATE_INDIVIDUAL_VIDEOS=2
NUMBER_OF_JOBS_FOR_INTEGRATION=1
...
USING_PYTHON_VIDEO_ANNOTATOR=False
VALIDATION="from_data"
CHECK_FOR_CROSSING_TIMEOUT=300
ADVANCED_SEGMENTATION=False
SKIP_EVERY_FRAME=1
EROSION_DISK_SKIP_EVERY_FRAME=100
IMPERFECT_FRAMES_FOLDER="imperfect/frames"
AI_LABELS_FOLDER="imperfect/yolov7/labels"
