...
if __name__ == '__main__':
    ...
    ************************************************************************ '''
    ...
    ''' ************************************************************************
    Save IMDB in to h5df
    ************************************************************************ '''
    numImagesPerIndiv = np.round(np.true_divide(totalNumImages,numIndivIMDB))
    imagesIMDB = np.vstack(imagesIMDB)
    labelsIMDB = np.vstack(labelsIMDB)

    nameDatabase =  ageInDpf + '_' + str(numIndivIMDB) + 'indiv_' + str(int(numImagesPerIndiv)) + 'ImPerInd_' + preprocessing
