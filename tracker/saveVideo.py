            ...
            if not isinstance(permutation,float):
                ...
                if currentFrame > 0 and sNumber == 1:
                    ...
                    while not isinstance(df.loc[previousFrame,'permutation'],float):
                        ...
                        previousPixels = df.loc[previousFrame,'pixels']
                        # globalPreviousFrame = frameIndices[frameIndices['frame']== previousFrame][frameIndices['segment']==sNumber].index[0]
                        # print 'segment number, ', sNumber
                        # print currentFrame
                        # print previousFrame
                        # print numFramesPast
                        if previousFrame < 0:
                            # print sum(frameIndices['frame'] == numFramesPast-previousFrame)
                            # print sum(frameIndices['segment']==sNumber-1)
                            # print frameIndices[frameIndices['frame'] == numFramesPast+previousFrame-1]
                            # print frameIndices[frameIndices['frame'] == numFramesPast-previousFrame-1][frameIndices['segment']==sNumber-1]
