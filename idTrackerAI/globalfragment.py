...
""" plotter """
def compute_and_plot_global_fragments_statistics(video, blobs, global_fragments, plot_flag = True):
    ...
    if plot_flag:
        ...
        hist, bin_edges = np.histogram(number_of_frames_in_individual_fragments_0, bins = 10 ** np.linspace(np.log10(MIN), np.log10(MAX), nbins))
        ...
        hist, bin_edges = np.histogram(number_of_frames_in_shortest_individual_fragment_0, bins = 10 ** np.linspace(np.log10(MIN), np.log10(MAX), nbins))
        ...
        hist, bin_edges = np.histogram(distance_travelled_individual_fragments_0, bins = 10 ** np.linspace(np.log10(MIN), np.log10(MAX), nbins))
        ax.semilogx(bin_edges[:-1], hist, '-ob' ,markersize = 5)
        # ax.plot(bin_edges[:-1], hist, '-ob' ,markersize = 5)
    ...
    return number_of_frames_in_individual_fragments_0, distance_travelled_individual_fragments_0
