...
def solve_duplications(list_of_fragments, first_frame_first_global_fragment):
    check_for_duplications_last_pass(list_of_fragments.fragments)
    solve_duplications_loop(list_of_fragments, first_frame_first_global_fragment, scope = 'to_the_past')
    solve_duplications_loop(list_of_fragments, first_frame_first_global_fragment, scope = 'to_the_future')
    check_for_duplications_last_pass(list_of_fragments.fragments)
