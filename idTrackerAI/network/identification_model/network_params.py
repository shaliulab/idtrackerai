...
class NetworkParams(object):
    ...
    def check_identity_transfer_consistency(self, CNN_model_info_dict):
        if CNN_model_info_dict['number_of_animals'] != self.number_of_animals:
        ...
        elif self.image_size[0] != self.image_size[1] or CNN_model_info_dict['image_size'][0] != CNN_model_info_dict['image_size'][1]:
            ...
            self.target_image_size = CNN_model_info_dict['image_size']
            ...
            if ratio_image_size >= .9 and ratio_image_size <= 1.1:
                ...
                self.image_size = self.target_image_size
