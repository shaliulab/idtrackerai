...
class P1B1(object):
    ...
    def compute(self):
        ...
        def runRepetition(self, loadCkpt_folder, images, labels, gCNN, g, n, r):
            ...
            # Update ckpt_dir
            if not self.kt:
                ckpt_dir = 'IdTrackerDeep/figuresPaper/P1B1/CNN_models/numIndiv_%i/numImages_%i/rep_%i' %(groupSize, groupSize, numImagesToUse, rep)
            elif self.kt:
                ckpt_dir = 'IdTrackerDeep/figuresPaper/P1B1/CNN_modelsKT/CNN_%i/numIndiv_%i/numImages_%i/rep_%i' %(groupSizeCNN, groupSize, groupSize, numImagesToUse, rep)
