...
from idtrackerai.groundtruth_utils.generate_groundtruth import GroundTruth, generate_groundtruth
                            ...
                            if len(list_of_global_fragments.global_fragments) > 0:
                                ...
                                results_data_frame = \
                                    results_data_frame.append({'date': time.strftime("%c"),
                                        ...
                                        'protocol': None,
                                        'overall_P2': None,
                                        'individual_accuracy_before_duplications': None,
                                        'accuracy_before_duplications': None,
                                        'individual_accuracy_assigned_before_duplications': None,
                                        'accuracy_assigned_before_duplications': None,
                                        'individual_accuracy_after_accumulation_before_duplications': None,
                                        'accuracy_after_accumulation_before_duplications': None,
                                        'individual_accuracy':  None,
                                        'accuracy': None,
                                        'individual_accuracy_assigned':  None,
                                        'accuracy_assigned':  None,
                                        'individual_accuracy_in_accumulation':  None,
                                        'accuracy_in_accumulation': None,
                                        'individual_accuracy_after_accumulation':  None,
                                        'accuracy_after_accumulation':  None,
                                        'crossing_detector_accuracy':  None,
                                        'individual_fragments_lengths': video.individual_fragments_lenghts,
                                        'number_of_global_fragments': list_of_global_fragments.number_of_global_fragments,
                                        'number_of_fragments': None,
                                        'number_of_crossing_fragments': None,
                                        'number_of_individual_fragments': None,
                                        'number_of_individual_fragments_not_in_a_global_fragment': None,
                                        'number_of_not_accumulable_individual_fragments': None,
                                        'number_of_globally_accumulated_individual_blobs': None,
                                        'number_of_partially_accumulated_individual_fragments': None,
                                        'number_of_blobs': None,
                                        'number_of_crossing_blobs': None,
                                        'number_of_individual_blobs': None,
                                        'number_of_individual_blobs_not_in_a_global_fragment': None,
                                        'number_of_not_accumulable_individual_blobs': None,
                                        'number_of_globally_accumulated_individual_fragments': None,
                                        'number_of_partially_accumulated_individual_blobs': None,
                                        'first_accumulation_time': None,
                                        'pretraining_time': None,
                                        'second_accumulation_time': None,
                                        'assignment_time': None,
                                        'solve_duplications_time': None,
                                        'total_time': None
                                         }, ignore_index=True)
