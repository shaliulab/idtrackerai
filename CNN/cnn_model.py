...
if __name__ == '__main__':
    ...
    numIndiv, imsize, X_train, Y_train, X_val, Y_val, X_test, Y_test, X_ref, Y_ref = loadDataBase(pathTrain, num_indiv, num_train, num_test, num_ref,ckpt_dir,pathTest)
    ...
    with tf.Session() as sess:
        ...
        if args.train == 0:
            ...
            # if loadCkpt_folder: # we load weights of another model (knowledge transfer) on test
            #     print 'loading weigths from ' + loadCkpt_folder
            ...
            #         saver_model.restore(sess,h_relust global_step
            print "\nStart from:", start
