...
if __name__ == '__main__':
    ...
    optimal_threshold = tf.Variable(0, name='optimal_threshold', trainable=False, dtype=tf.float32)
    # idTracker accuracy
    ...
    with tf.Session() as sess:
        ...
        if args.train == 2:
            ...
            opTh = optimal_threshold.eval() # get last global_step
            ...
            # print '..................'
            # print "refImages"
            # print np.asarray(refImages).shape
            # print '..................'
            # print '..................'
            # print "probImages"
            # print np.asarray(probImages).shape
            # print '..................'
            # print '..................'
            # print "refLabels"
            # print np.asarray(refLabels).shape
            # print '..................'
            # print '..................'
            # print "probLabels"
            # print np.asarray(probLabels).shape
            # print '..................'
            # featProb, featRef,subtracted, distance, thresholded_dist = sess.run([featProbRep, featRefRep, subtraction, dist, match],
            #                 feed_dict={
            #                     x1: probImages,
            #                     x2: refImages,
            #                     yProb: probLabels,
            ...
            #                 })
            # print "featProb"
            # pprint.pprint(np.asarray(featProb).shape)
            # print "featRef"
            # pprint.pprint(np.asarray(featRef).shape)
            # print "subtracted"
            # pprint.pprint(np.asarray(subtracted).shape)
            # print "dist"
            # pprint.pprint(np.asarray(distance).shape)
            # print "thresholded_dist"
            # pprint.pprint(np.asarray(thresholded_dist).shape)
            # # print [p1 for i,p1 in enumerate(thresholded_dist) if i % 15 == 0]
            # print "-------------------"
            ...
            # print "featProb"
            # pprint.pprint(np.asarray(featP).shape)
            # print "featRef"
            # pprint.pprint(np.asarray(featR).shape)
            # print [p1 for i,p1 in enumerate(thresholded_dist) if i % 15 == 0]
            print "-------------------"

            # let's consider a single problem images
            # print "test image's feature vector"
            # ind = 1
            ...
            print "individuals problem images: " +  str(countRate(probLabels))
            print "individuals reference images: " +  str(countRate(refLabels))
            indivAcc = np.zeros(numIndivProb)
            numIndivPerClassProb = [countRate(probLabels)[i][1] for i in range(len(countRate(probLabels)))]
